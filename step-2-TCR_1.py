...
def train_tcr(model, train_loader, fold, epoch, epochs):
    model.encoder_P.load_state_dict(torch.load('UnifyImmun/HLA_1/encoder_P_{}.pth'.format(fold)))
    train_time = 0
    model.train()
...
for fold in range(1, 6):
    ...
    print('TCR Train:')
    path_all_tcr = 'UnifyImmun/TCR_1'
    save_path_tcr = 'UnifyImmun/TCR_1/model_TCR_fold{}.pkl'.format(fold)
    encoder_path_tcr = 'UnifyImmun/TCR_1/encoder_P_{}.pth'.format(fold)
