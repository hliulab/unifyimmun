...
independent_loader = data_load_HLA(type_='Neoantigen', fold=None, batch_size=batch_size)
...
for fold in range(1, 2):
    ...
    print('Load HLA Data:')
    path_all = '../trained model/HLA_2'
    save_path = '../trained model/HLA_2/model_HLA_fold{}.pkl'.format(fold)
